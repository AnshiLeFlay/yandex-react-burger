        ...
        <>
            ...
            <div className={styles.show_scroll + " custom-scroll mt-10"}>
                <div id="buns-section" ref={bunsRef}>
                    ...
                    <div className="pl-4">
                        {data
                            .filter((filterElem) => filterElem.type === "bun")
                            .map((elem: TIngredient) => (
                                ...
                                >
                                    <Link
                                        ...
                                        onClick={() => {
                                            dispatch({
                                                type: DELETE_DATA_INGREDIENTS_MODAL,
                                            });
                                        }}
                                        to={{
                ...
                <div ref={sauceRef} id="sauce-section">
                    ...
                    <div className="pl-4">
                        {data
                            .filter((filterElem) => filterElem.type === "sauce")
                            .map((elem: TIngredient) => (
                                <DraggableItem
                                    key={"sauce_" + elem._id}
                                    data={{
                ...
                <div ref={mainRef} id="main-section">
                    ...
                    <div className="pl-4">
                        {data
                            .filter((filterElem) => filterElem.type === "main")
                            .map((elem: TIngredient) => (
                                <DraggableItem
                                    key={"main_" + elem._id}
                                    data={{
